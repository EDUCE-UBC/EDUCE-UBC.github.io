...
- We are going to update all installed programs. In Ubuntu, enter the following commands:

  ```{bash eval = FALSE}
  sudo apt update && sudo apt upgrade
  ```
  
- As a final step, we install the program "cURL" that allows us to download files using the command line on Ubuntu.
