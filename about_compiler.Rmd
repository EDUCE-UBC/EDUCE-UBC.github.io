...
Alternatively, if you would like to manually add courses or customize your Rmd, you can select the ZIP format in the app, add your own Rmd files to the `Rmd_Input` folder, and edit the Rmd_Master_File.
