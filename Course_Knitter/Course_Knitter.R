...
files <- Sys.glob("C:/Users/Administrator/Desktop/CPSC448/EDUCE/_User/Rmd_Input/*.Rmd")
courses <- gsub("^C:/Users/Administrator/Desktop/CPSC448/EDUCE/_User/Rmd_Input/", "", files)
...
ui <- fluidPage("", id = "navibar", theme = shinytheme("darkly"), useShinyjs(), useShinyalert(), 
                ...
                sidebarLayout(
                  ...
                  sidebarPanel(
                    ...
                    actionButton("return", label = "Return to EDUCE", icon = icon("home"), onclick ="location.href='http://google.com';"),
...
server <- function(input, output, session) {
  ...
  output$downloadReport <- downloadHandler(
    ...
    content = function(file) {
      # Clear out folders ----
      do.call(file.remove, list(list.files("C:/Users/Administrator/Desktop/CPSC448/EDUCE/_User/Rmd_Output", full.names = TRUE)))
      do.call(file.remove, list(list.files("C:/Users/Administrator/Desktop/CPSC448/EDUCE/_User/Download_Output/Rmd_Output", full.names = TRUE)))
      ...
      for (i in input_list) {
        file.copy(i, "C:/Users/Administrator/Desktop/CPSC448/EDUCE/_User/Rmd_Output")
      }
      
      # Run script for generating files ---- 
      out <- render("C:/Users/Administrator/Desktop/CPSC448/EDUCE/_User/User_File.Rmd", switch(
        input$format,
        PDF = pdf_document(), HTML = html_document()
      ))
      
      # Display file to user for download ----
      out <- render("C:/Users/Administrator/Desktop/CPSC448/EDUCE/_User/Rmd_Master_File.Rmd", switch(
        input$format,
        PDF = pdf_document(), HTML = html_document()
      ))
      
      if (input$format == "ZIP") {
        setwd("C:/Users/Administrator/Desktop/CPSC448/EDUCE/_User")
        file.copy("C:/Users/Administrator/Desktop/CPSC448/EDUCE/_User/Rmd_Master_File.Rmd", "C:/Users/Administrator/Desktop/CPSC448/EDUCE/_User/Download_Output")
        
        file.copy("C:/Users/Administrator/Desktop/CPSC448/EDUCE/_User/User_File.Rmd", "C:/Users/Administrator/Desktop/CPSC448/EDUCE/_User/Download_Output")
        
        file.copy("C:/Users/Administrator/Desktop/CPSC448/EDUCE/_User/Rmd_Output", "C:/Users/Administrator/Desktop/CPSC448/EDUCE/_User/Download_Output", recursive = TRUE)
        
        OutputZip <- dir('Download_Output', full.names = TRUE)
        
        zip(zipfile = 'EDUCE_Courses', files = OutputZip)
        
        out <- c("C:/Users/Administrator/Desktop/CPSC448/EDUCE/_User/EDUCE_Courses.zip")
      }
