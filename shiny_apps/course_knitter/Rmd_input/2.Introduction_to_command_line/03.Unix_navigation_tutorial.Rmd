...
```
```
Applications    GitHub          Pictures        example
Desktop         Google Drive    Public          test.txt
Documents       Library         README.md
Documents_large Movies          Video
...
1. You can go **up one directory** using `cd ..` 
    ...
    - You can repeat this as many times as you want and continue to go up one directory at a time as shown below.
