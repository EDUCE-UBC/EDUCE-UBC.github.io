...
The installation instructions below assume that you have already set up your [Linux](linux.html) or [macOS](bash.html) system or, if you are on a Windows machine, installed the [Windows Subsystem for Linux (WSL)](wsl.html).
