...
### Provided Files in ZIP Format
  ...
  - Rmd_Input = All the courses that you selected.
...
1) Follow the instructions above to obtain the downloadable version of Course Compiler.
2) Put your own Rmd files into the folder called "Rmd_Input".
3) Run the app and select the courses that you want to knit (Order of selection matters).
