...
4. Finally, you need to change your environment variables to ensure you can run R scripts from GitBash:
    ...
    - In the next window that pops up click the "Browse" button and navigate to the folder that contains the `Rscript.exe` file. The path should look approximately like `C:/Program Files/R/R-4.0.4/bin/Rscript.exe`.
