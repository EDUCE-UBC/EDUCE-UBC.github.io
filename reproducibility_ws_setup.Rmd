...
3. If you do not already have one, sign up for an account on [GitHub](https://github.com/).
4. Configure your GitHub user name and email (the email address you used to register on GitHub). To do this, open GitBash and type:
